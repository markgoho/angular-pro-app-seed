    ...
    <div class="workout-form">
      ...
      <form [formGroup]="form">
        ...
        <div class="workout-form__name">
          ...
          <label for="name">
            <h3>Workout name</h3>
            <input type="text" [placeholder]="placeholder" formControlName="name" id="name">
        ...
        <div class="workout-form__details">
          ...
          <div *ngIf="form.get('type').value === 'endurance'">
            ...
            <div class="workout_form__fields" formGroupName="endurance">
              <label>
        ...
        <div class="workout-form__submit">
          ...
          <div *ngIf="!exists">
            <button type="button" class="button" (click)="createWorkout()">Create workout</button>
            <a [routerLink]="['../']" class="button button--cancel">Cancel</a>
          </div>

          <div *ngIf="exists">
            <button type="button" class="button" (click)="updateWorkout()">Save</button>
            <a [routerLink]="['../']" class="button button--cancel">Cancel</a>
          </div>
